 ...
 */
public class UsbPager extends BasePager{
    ...
    public UsbPager(Activity mActivity) {
        super(mActivity);
    }

    @Override
    public View initView() {
        View view = View.inflate(mActivity, R.layout.pager_usb,null);
    ...
    public void initData() {
        ...
        //标题
        Product titleProduct = new Product(0,null,null,Constant.module_type[1],Constant.module_myflag[1]);
