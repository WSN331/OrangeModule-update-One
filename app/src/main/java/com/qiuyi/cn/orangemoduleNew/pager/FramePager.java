 ...
 * 框架模块
 */
public class FramePager extends BasePager{
    ...
    public FramePager(Activity mActivity) {
        super(mActivity);
    }

    @Override
    public View initView() {
        View view = View.inflate(mActivity, R.layout.pager_frame,null);
    ...
    public void initData() {
        ...
        //标题
        Product titleProduct = new Product(0,null,null,Constant.module_type[0],Constant.module_myflag[1]);
