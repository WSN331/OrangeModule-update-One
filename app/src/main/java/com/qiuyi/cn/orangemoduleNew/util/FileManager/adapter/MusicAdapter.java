package com.qiuyi.cn.orangemoduleNew.util.FileManager.adapter;
...
import com.qiuyi.cn.orangemoduleNew.util.FileManager.bean1.MusicBean;
 ...
 */
public class MusicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener,View.OnLongClickListener{
    ...
    public boolean onLongClick(View view) {
        if(myMusicItemClick!=null){
            myMusicItemClick.onLongClick(view, (int) view.getTag(),sorListFile);
        }
        return false;
    }
    ...
    public interface MusicItemClick{
        ...
        void onLongClick(View view,int position,List<MusicBean> allMusicBean);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(getItemViewType(position)==2){
            ...
            myholder.cb_item.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    flag[position] = b;
                    isToSelectMusicAll(position,sorListFile,flag);
...
/*            imgFlag.setImageResource(R.drawable.music);
            fileInfo.getPath()
            Glide.with(context)
                    .load(R.drawable.qq)
            ...
            tv_ad_title.setText(new SimpleDateFormat("yyyy-MM-dd").format(new Date(fileInfo.getDate()*1000L)));
        }
    }
