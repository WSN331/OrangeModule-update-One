...
package com.qiuyi.cn.orangemoduleNew.upansaf.usb;
...
/*    *//**
     ...
     * @param
     */
    public static void moveFileToSD(Context context, File infile, DocumentFile outfile){
        Log.i("TTTTTT","开始移动");
        ...
        try {
            ...
            if(infile.isDirectory()){
                ...
                for(File file:infile.listFiles()){
                    moveFileToSD(context,file,newFile);
                }

            }else{

                newFile = outfile.createFile(com.qiuyi.cn.orangemoduleNew.util.FileUtil.getMIMEType(infile), infile.getName());
            }
            OutputStream out = context.getContentResolver().openOutputStream(newFile.getUri());
            /*input = context.getContentResolver().openInputStream(infile.getUri());*/
