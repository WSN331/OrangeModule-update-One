...
public class CommomDialog extends Dialog implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.cancel:
                if(listener != null){
                    listener.onClick(this,null,false);
                }
                this.dismiss();
                break;
            case R.id.submit:
                if(listener != null){
                    String name = contentTxt.getText().toString();
                    if(!TextUtils.isEmpty(name)){
                        listener.onClick(this, name,true);
                    }else{
    ...
    public interface OnCloseListener{
        void onClick(Dialog dialog,String folderName, boolean confirm);
    }
}
